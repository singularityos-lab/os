...
SINTY_RECOVERY_UI_VERSION = local
SINTY_RECOVERY_UI_SITE = /home/mirko/Projects/personal/sinty-recovery/ui/cairo
SINTY_RECOVERY_UI_SITE_METHOD = local
SINTY_RECOVERY_UI_LICENSE = GPL-3.0-only
SINTY_RECOVERY_UI_LICENSE_FILES = subprojects/singularity-loginui/LICENSE
...
SINTY_RECOVERY_UI_ZIG = /home/mirko/.local/bin/zig
...
define SINTY_RECOVERY_UI_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(@D)/zig-out/bin/sinty-recovery-ui $(TARGET_DIR)/usr/bin/sinty-recovery-ui
endef
